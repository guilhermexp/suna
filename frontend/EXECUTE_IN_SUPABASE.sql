...
-- Create storage bucket for note attachments (execute separately in Storage section)
...
-- ============================================
-- SEED DATA - Create default tags for existing users
-- ============================================
...
DO $$
BEGIN
  RAISE NOTICE 'Notes system tables created successfully!';
  ...
  RAISE NOTICE '1. Create storage bucket "note-attachments" in Storage section';
  RAISE NOTICE '2. Test by creating your first note!';
END $$;