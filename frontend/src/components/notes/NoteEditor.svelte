				...
				<div class=" w-full flex flex-col {loading ? 'opacity-20' : ''}">
					<div class="shrink-0 w-full flex justify-between items-center px-3.5 mb-1.5">
						<div class="w-full flex items-center">
							...
							<!-- Botão de voltar para lista de notas -->
							<Tooltip content={$i18n.t('Back to Notes')}>
								<button
									class="flex items-center justify-center p-1.5 mr-2 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-850 transition"
									on:click={() => {
										goto('/notes');
									}}
								>
					...
					<div
						bind:this={noteContentContainer}
